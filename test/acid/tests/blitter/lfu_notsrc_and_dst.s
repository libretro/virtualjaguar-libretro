;
; tests/blitter/lfu_notsrc_and_dst.s - LFU=$2 (~S & D).
;
; SRC=$AAAA5555, DST=$CCCC3333:
;   Upper nybbles: S=A(1010), D=C(1100) -> ~S & D = 0101 & 1100 = 0100
;   Lower nybbles: S=5(0101), D=3(0011) -> ~S & D = 1010 & 0011 = 0010
;   -> result = $44442222
;
; Needs SRCEN+DSTEN.
;
...
entry:
                ...
                move.l  #SRCEN|DSTEN|LFU_FN_2,B_COMMAND
