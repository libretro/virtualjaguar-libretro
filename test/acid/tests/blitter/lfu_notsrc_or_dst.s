;
; tests/blitter/lfu_notsrc_or_dst.s - LFU=$B (~S | D).
;
; SRC=$AAAA5555, DST=$CCCC3333:
;   Upper nybbles: ~A | C = 0101 | 1100 = 1101 -> D
;   Lower nybbles: ~5 | 3 = 1010 | 0011 = 1011 -> B
;   -> result = $DDDDBBBB
;
; Needs SRCEN+DSTEN.
;
...
entry:
                ...
                move.l  #SRCEN|DSTEN|LFU_FN_B,B_COMMAND
