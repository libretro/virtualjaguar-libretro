;
; tests/gpu/gpu_op_imult.s - GPU IMULT opcode strict result check.
;
; r0=$FFFE (-2 as int16), r1=3; IMULT r0,r1 => r1 = -6 = $FFFFFFFA.
;
; Detail codes:
...
entry:
                ...
                lea     GPU_RAM.l,a0
                ;; movei #$FFFE, r0  (low half of register holds $FFFE = -2 as int16)
                move.w  #$9800,(a0)+
                move.w  #$FFFE,(a0)+
                move.w  #$0000,(a0)+
                ;; movei #3, r1
