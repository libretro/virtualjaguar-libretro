;
; tests/gpu/gpu_op_shrq.s - GPU SHRQ opcode strict result check.
;
; r1=$10000000; SHRQ #4, r1 => r1 = $01000000.
;
; SHRQ encoding: IMM_1 is the literal shift count (gpu_convert_zero
; maps 0 to 32 but 1..31 to themselves).
;
; Detail codes:
...
entry:
                ...
                move.w  #$0000,(a0)+
                move.w  #$1000,(a0)+
                ;; shrq #4, r1   (op=25=$6400, reg1=4=$80, reg2=r1=1) => $6481
                move.w  #$6481,(a0)+
                ;; movei #$00080000, r2
                move.w  #$9802,(a0)+
                move.w  #$0000,(a0)+
