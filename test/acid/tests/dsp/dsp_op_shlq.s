;
; tests/dsp/dsp_op_shlq.s - DSP SHLQ opcode strict result check.
;
; r1=$00000001; SHLQ #4, r1 => r1 = $10.  IMM_1 encoded as 32-shift = 28.
;
...
entry:
                ...
                move.w  #1,(a0)+
                move.w  #$0000,(a0)+
                ;; shlq #4, r1  (op=24=$6000, IMM_1=28=$1C, reg2=r1=1) -> $6381
                move.w  #$6381,(a0)+
                move.w  #$9802,(a0)+
