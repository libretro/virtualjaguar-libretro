;
; tests/dsp/dsp_op_add.s - DSP ADD opcode strict result check.
;
; Same as gpu_op_add but on the DSP.  DSP and GPU share the RISC ISA,
; so opcode encodings are identical.
;
; Detail codes:
;   1 = wrong stored value
;   2 = sentinel intact (DSP never wrote)
;
