;
; tests/dsp/dsp_op_moveq.s - DSP MOVEQ opcode strict result check.
;
; DSP MOVEQ does RN = IMM_1 (raw 5-bit field, no sign extension).
; Pre-load r0 with $FFFFFFFF, run MOVEQ #$1F,r0, expect r0=$1F.
;
...
entry:
                ...
                move.w  #$FFFF,(a0)+
                move.w  #$FFFF,(a0)+
                ;; moveq #$1F, r0   (op=35=$8C00, IMM_1=$1F, reg2=0) -> $8FE0
                move.w  #$8FE0,(a0)+
                move.w  #$9802,(a0)+
