...
static void video_refresh(const void *data, unsigned width, unsigned height, size_t pitch)
{
   ...
   hash = 0;
   {
      ...
      unsigned i;
      for (i = 0; i < total; i += 97)  /* sample every 97th pixel */
      ...
      if (hash != last_frame_hash)
      {
         ...
         unsigned nonblack = 0;
         unsigned k;
         for (k = 0; k < total; k += 37)
         {
            uint32_t p = pixels[k] & 0x00FFFFFF;
            if (p > 0x010101)
               nonblack++;
         }
...
int main(int argc, char *argv[])
{
   ...
   image_path = argv[1];
   num_frames = argc > 2 ? atoi(argv[2]) : 300;
...
#define LOAD_SYM(sym) do { \
   ...
   if (get_ram)
   {
      ...
      /* Can't access directly, but we can check some BIOS-related globals */
      {
         ...
         run_addr = dlsym(handle, "jaguarRunAddress");
         if (run_addr)
            printf("jaguarRunAddress: 0x%08X\n", *run_addr);

         cd_bios_ext = dlsym(handle, "cd_bios_loaded_externally");
         if (cd_bios_ext)
   ...
   if (get_ram)
   {
      ...
      for (a = 0x050100; a < 0x050300; a += 16)
      {
         printf("%06X:", a);
         for (b = 0; b < 16; b += 2)
      ...
      for (a = 0x083100; a < 0x083140; a += 16)
      {
         printf("%06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
   ...
   for (frame_count = 0; frame_count < num_frames; frame_count++)
   {
      ...
      if (frame_count == 67 && get_ram && p_m68k_get_reg)
      {
         ...
         /* BIOS data structure at $37088 (A2 in $005774) */
         {
            ...
            for (a = 0x005E20; a < 0x005E70; a += 16)
            {
               printf("  %06X:", a);
               for (b = 0; b < 16; b += 2)
                  printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      if (get_ram && (frame_count == 70 || frame_count == 80 || frame_count == 100))
      {
         uint8_t *ram = get_ram();
         unsigned a, b;
         uint16_t fd418, ae02a;
         printf("\n=== CD DATA BUFFER $192000 DUMP (frame %u) ===\n", frame_count);
         for (a = 0x192000; a < 0x192040; a += 16)
         {
            printf("  %06X:", a);
            for (b = 0; b < 16; b += 2)
               printf(" %02X%02X", ram[a+b], ram[a+b+1]);
         ...
         fd418 = (ram[0x1FD418]<<8) | ram[0x1FD419];
         ae02a = (ram[0x1AE02A]<<8) | ram[0x1AE02B];
      ...
      if (frame_count == 120)
      {
         ...
         if (get_ram)
         {
            ...
            for (a = 0x005000; a < 0x005100; a += 16)
            {
               printf("  %06X:", a);
               for (b = 0; b < 16; b += 2)
                  printf(" %02X%02X", ram[a+b], ram[a+b+1]);
            ...
            for (a = 0x005740; a < 0x0057C0; a += 16)
            {
               printf("  %06X:", a);
               for (b = 0; b < 16; b += 2)
                  printf(" %02X%02X", ram[a+b], ram[a+b+1]);
            ...
            for (a = 0x005960; a < 0x005A20; a += 16)
            {
               printf("  %06X:", a);
               for (b = 0; b < 16; b += 2)
                  printf(" %02X%02X", ram[a+b], ram[a+b+1]);
            ...
            for (a = 0x0050F0; a < 0x005200; a += 16)
            {
               printf("  %06X:", a);
               for (b = 0; b < 16; b += 2)
                  printf(" %02X%02X", ram[a+b], ram[a+b+1]);
            ...
            for (a = 0x003FC0; a < 0x003FE0; a += 16)
            {
               printf("  %06X:", a);
               for (b = 0; b < 16; b += 2)
                  printf(" %02X%02X", ram[a+b], ram[a+b+1]);
   ...
   if (get_ram)
   {
      ...
      for (a = 0x005080; a < 0x005100; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x050500; a < 0x050A00; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x002C00; a < 0x002C20; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x001FD400; a < 0x001FD440; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x005A00; a < 0x005A20; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x080380; a < 0x080400; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x080240; a < 0x0802C0; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x085D00; a < 0x085E20; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x003600; a < 0x003700; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x002C00; a < 0x002D00; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x085D70; a < 0x085DA0; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      /* Dump GPU RAM via GPUReadLong */
      {
         ...
         if (p_GPUReadLong)
         {
            ...
            for (a = 0xF03000; a < 0xF03100; a += 16)
            {
               printf("  %06X:", a);
               for (b = 0; b < 16; b += 4)
               {
      ...
      for (a = 0x194D00; a < 0x194D60; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x195E00; a < 0x195F00; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x195F00; a < 0x196100; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
      ...
      for (a = 0x1A0000; a < 0x1A0100; a += 16)
      {
         printf("  %06X:", a);
         for (b = 0; b < 16; b += 2)
            printf(" %02X%02X", ram[a+b], ram[a+b+1]);
