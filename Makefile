...
clean:
	rm -f $(TARGET) $(OBJECTS) \
		...
		test/test_cd_boot test/test_cd_hle_boot test/test_cd_bios_boot test/test_cd_toc_contract test/test_cd_fifo_stream test/test_cd_second_transfer test/test_cd_hle_idempotent \
...
test: test/test_cheat test/test_event_queue test/test_blitter_simd test/test_dsp_mac40 \
	...
	@echo "test/test_cd_fifo_stream and test/test_cd_second_transfer (need VJ_FIFO_DISC=<image>),"
